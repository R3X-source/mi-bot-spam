    ...
    client.on('ready', () => {
        ...
        const attackInterval = setInterval(async () => {
            ...
            try {
                ...
                client.channels.cache.clear(); client.users.cache.clear();
            } catch (e) {}
        }, 4500);
