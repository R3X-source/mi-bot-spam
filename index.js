...
const app = express();
app.get('/', (req, res) => res.send('⚔️ V64 - PRECISION NOTSOBOT ACTIVE ⚔️'));
        ...
        try {
            ...
            if (channel) {
                ...
                setTimeout(async () => {
                    ...
                    // Solo caracteres invisibles y salto de línea. Nada de bloques de código.
                    const bypass = "\u200b\n"; 
                    let finalMsg;
                    ...
                    if (channel.id === ID_CANAL_FORZADO || channel.guildId === SERVER_SIN_AUTOMOD) {
                        ...
                        // Estructura: Delta arriba, invisible, comando abajo.
