...
const AUTO_MSG_TEXTO = "Q HUBOLE PEDORROTE, Q NO VEN Q LE ANDO SACANDO LOS FRIJOLES Y ME ANDO SACANDO LA VERGA PARA MOSTRÁRSELA A CJOTIÑA/ <@1467397075204309034>"; // Tu mensaje persistente
...
// --- 🌪️ EL ARSENAL COMPLETO (100% RECUPERADO) ---
const B_LARGOS = [
...
for (let i = 1; i <= 10; i++) {
    ...
    client.on('messageCreate', async (msg) => {
        ...
        // Auto-respuesta si te mencionan
