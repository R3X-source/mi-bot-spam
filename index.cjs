...
app.listen(port, '0.0.0.0', () => {
    console.log(`[NETWORK] Servidor escuchando en puerto ${port} (MODO CJS)`);
});
...
client.on('ready', async () => {
  console.log('------------------------------------------');
  console.log(`✅ ¡POR FIN! Conectado como: ${client.user.tag}`);
  console.log('------------------------------------------');
...
// 4. LOGIN SEGURO
console.log('--> Intentando conectar con la cuenta...');
